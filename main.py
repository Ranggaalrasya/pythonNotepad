...
def save_file():
    ...
    new_win.title('Save File - RangNote')
...
def open_file():
    ...
    new_win.title('Open File - RangNote')
...
def delete_file():
    ...
    new_win.title('Delete File - RangNote')
...
def about_notepad():
    ...
    info = LabelFrame(new_win, text='About RangNote', fg='black')

    info.grid(row=0, column=0)

    info_label = Label(info,
                       text='RangNote is an app developed by RangDev.\n It is an open-sourced notepad application.\n'
                            ...
                            'Creator - Rangga Alrasya.', fg='black', bg='white')
...
def navigation():
    ...
    navigate_label = Label(navigate_frame, text='Welcome to RangNote Navigation!\n\n\n'
...
def terms():
    ...
    terms_label = Label(terms_frame, text='Terms And Conditions - RangNote\n \n \n \n'
...
help.add_command(label='About RangDev Notepad', command=about_notepad)
